...
private:
    ...
    bool is_expr();
    ExprNode* expr();
    ExprNode* expr_o(ExprNode* lhs);
    ExprNode* expr_and();
    ExprNode* expr_and_o(ExprNode* lhs);
    ExprNode* expr_eq();
    ExprNode* expr_eq_o(ExprNode* lhs);
    ExprNode* expr_rel();
    ExprNode* expr_rel_o(ExprNode* lhs);
    ExprNode* expr_add();
    ExprNode* expr_add_o(ExprNode* lhs);
    ExprNode* expr_mult();
    ExprNode* expr_mult_o(ExprNode* lhs);
    ExprNode* expr_unary();
    ExprNode* factor();
    ...
    ExprNode* op_mult(ExprNode* lhs, ExprNode* rhs);
